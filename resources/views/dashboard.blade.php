                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-dark">
                            ...
                            <a href="categorys" class="small-box-footer">Más Información <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!--COL--->
                    <div class="col-lg-3 col-6">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-dark">
                            ...
                            <div class="icon">
                            <i class="fas fa-solid fa-pen-fancy"></i>
                            </div>
                            <a href="vendors" class="small-box-footer">Más Información <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                     <!--COL--->
                     <div class="col-lg-3 col-6">
