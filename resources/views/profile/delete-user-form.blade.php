...
<x-slot name="title"> <br>
    ...
    <x-slot name="content">
        ...
        <div class="mt-5" style="text-align: end;">
            <x-danger-button wire:click="confirmUserDeletion" wire:loading.attr="disabled" style="background-color:black;">
              <b>  {{ __('BORRAR CUENTA') }} </b>
            </x-danger-button>
        </div>
        ...
        <x-dialog-modal wire:model.live="confirmingUserDeletion">
            ...
            <x-slot name="footer">
                <x-secondary-button wire:click="$toggle('confirmingUserDeletion')" wire:loading.attr="disabled" style="background-color:black;">
                  <b> {{ __('CANCELAR') }} </b> 
                </x-secondary-button>

                <x-danger-button class="ms-3" wire:click="deleteUser" wire:loading.attr="disabled" style="background-color:black;">
                   <b> {{ __('BORRAR CUENTA') }} </b> 
                </x-danger-button>
            </x-slot>
        </x-dialog-modal>
